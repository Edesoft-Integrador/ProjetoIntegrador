...
import ArquivoInsert from 'ArquivoInsert';

import './components/NavMenu.css';
export class ArquivoView extends Component {
  constructor(props) {
    super(props);
    this.state = {
      isAddProduct: false,
  ...
  render() {
    ...
    if(this.state.isAddProduct || this.state.isEditProduct) {
      productForm = <ArquivoInsert onFormSubmit={this.onFormSubmit} product={this.state.product} />
    }
    ...
    return (
      <div className="App">
        <Container>
          ...
          {!this.state.isAddProduct && <ArquivoInsert editProduct={this.editProduct}/>}
          { productForm }
