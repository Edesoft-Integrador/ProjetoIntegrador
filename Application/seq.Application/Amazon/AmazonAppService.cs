...
namespace seq.Application.Amazon
{
    public class AmazonAppService : IAmazonAppService
    {
        ...
        public AmazonAppService(IAmazonHeaderRepository contextHeader, IAmazonDetalheRepository contextDetalhe)
        {
            _contextHeader = contextHeader;
            _contextDetalhe = contextDetalhe;
        }

        public Task<bool> Delete(AmazonModel obj)
        {
            throw new NotImplementedException();
        }

        public Task<AmazonModel> Find(AmazonModel obj)
        {
            throw new NotImplementedException();
        }

        public Task<long> Insert(AmazonModel obj)
        {
            throw new NotImplementedException();
        }
        ...
        public Task<List<AmazonModel>> Search(AmazonModel obj)
        {
            throw new NotImplementedException();
        }

        public Task<bool> Update(AmazonModel obj)
        {
            throw new NotImplementedException();
        }
    }
